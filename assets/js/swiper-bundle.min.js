...
const Swiper = ( function () {
    ...
    function g( e, t = '' ) {
        const s = r(),
            a = [ ...e.children ];
        return (
            s.HTMLSlotElement && e instanceof HTMLSlotElement && a.push( ...e.assignedElements() ), t ? a.filter( e => e.matches( t ) ) : a
        );
    }
    function v( e ) {
        try {
    ...
    const be = [
        ...
        function ( { swiper: e, extendParams: t, on: s, emit: a } ) {
            ...
            function l() {
                return (
                    ! e.params.pagination.el || ! e.pagination.el || ( Array.isArray( e.pagination.el ) && 0 === e.pagination.el.length )
                );
            }
            function o( t, s ) {
                ...
                if ( 'bullets' === t.type ) {
                    ...
                    for ( let s = 0; s < a; s += 1 ) {
                        t.renderBullet
                            ...
                            : ( r += `<${ t.bulletElement } ${ e.isElement ? 'part="bullet"' : '' } class="${ t.bulletClass }"></${
                                  t.bulletElement
                              }>` );
                    }
                }
        ...
        function ( { swiper: e, extendParams: t, on: s, emit: i } ) {
            ...
            function C() {
                ...
                if ( ( 'string' === typeof a.el && e.isElement && ( i = e.el.querySelector( a.el ) ), i || 'string' !== typeof a.el ) ) {
                    i || ( i = a.el );
                } else if ( ( ( i = r.querySelectorAll( a.el ) ), ! i.length ) ) {
                    return;
                }
                e.params.uniqueNavElements &&
                    'string' === typeof a.el &&
        ...
        function ( { swiper: e, extendParams: t, on: s } ) {
            ...
            fe( {
                ...
                setTranslate: () => {
                    ...
                    ( s.style.transform = `translate3d(0px,0,${ g }px) rotateX(${ c( e.isHorizontal() ? 0 : f ) }deg) rotateY(${ c(
                        e.isHorizontal() ? -f : 0
                    ) }deg)` ),
                ...
                fe( {
                    ...
                    setTranslate: () => {
                        ...
                        for ( let e = 0, t = a.length; e < t; e += 1 ) {
                            ...
                            if (
                                ( ( ge( 0, t ).style.transform = y ), ( t.style.zIndex = 1 - Math.abs( Math.round( u ) ) ), r.slideShadows )
                            ) {
