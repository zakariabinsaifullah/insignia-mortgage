...
import { NativeRangeControl, NativeToggleControl, NativeResponsiveControl } from '../../components';

const Inspector = props => {
    const { attributes, setAttributes } = props;
    const { qcTotalPosts, qcColumns, qcGaps, qcAutoplay, qcDelay, qcLoop, qcShowArrows, qcShowPagination, qcExcludeCurrentPost, resMode } =
        attributes;
