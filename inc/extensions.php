...
if ( ! function_exists( 'insignia_enqueue_group_floating_border_editor_assets' ) ) :
	/**
	 * Enqueues the group-floating-border extension script and editor stylesheet.
	 */
	function insignia_enqueue_group_floating_border_editor_assets() {
		...
		wp_enqueue_script(
			'insignia-group-floating-border-extension',
...
add_action( 'enqueue_block_editor_assets', 'insignia_enqueue_group_floating_border_editor_assets' );


if ( ! function_exists( 'insignia_enqueue_group_floating_border_frontend_assets' ) ) :
	/**
	 * Enqueues the group-floating-border frontend stylesheet.
	 */
	function insignia_enqueue_group_floating_border_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/group-floating-border/index.asset.php' );
		...
		wp_enqueue_style(
			'insignia-group-floating-border-extension-style',
...
add_action( 'enqueue_block_assets', 'insignia_enqueue_group_floating_border_frontend_assets' );


if ( ! function_exists( 'insignia_render_group_floating_border' ) ) :
	/**
...
if ( ! function_exists( 'insignia_enqueue_kadence_featured_bg_editor_assets' ) ) :
	/**
	 * Enqueues the kadence-featured-bg extension script and editor stylesheet.
	 */
	function insignia_enqueue_kadence_featured_bg_editor_assets() {
		...
		wp_enqueue_script(
			'insignia-kadence-featured-bg-extension',
...
add_action( 'enqueue_block_editor_assets', 'insignia_enqueue_kadence_featured_bg_editor_assets' );


if ( ! function_exists( 'insignia_enqueue_kadence_featured_bg_frontend_assets' ) ) :
	/**
	 * Enqueues the kadence-featured-bg frontend stylesheet.
	 */
	function insignia_enqueue_kadence_featured_bg_frontend_assets() {
		$asset_file = get_theme_file_path( 'build/extensions/kadence-featured-bg/index.asset.php' );
		...
		wp_enqueue_style(
			'insignia-kadence-featured-bg-extension-style',
...
add_action( 'enqueue_block_assets', 'insignia_enqueue_kadence_featured_bg_frontend_assets' );


if ( ! function_exists( 'insignia_render_kadence_featured_bg' ) ) :
	/**
	 ...
	 * @return string Modified block HTML.
	 */
	function insignia_render_kadence_featured_bg( $block_content, $block ) {
...
add_filter( 'render_block', 'insignia_render_kadence_featured_bg', 10, 2 );
